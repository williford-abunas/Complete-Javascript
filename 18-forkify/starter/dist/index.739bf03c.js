...
const KEY = "e8bedbf8-4a70-4ccb-a688-7c6bb479eb51";
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"3umpu","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        const generateForwardButton = (curPage)=>`<button data-goto="${curPage + 1}" class="btn--inline pagination__btn--next">
      <span>Page ${curPage + 1}</span>
      <svg class="search__icon">
        <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
      </svg>
    </button>`;
        const generateBackButton = (curPage)=>`<button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
      <svg class="search__icon">
      ...
      <span>Page ${curPage - 1}</span>
        ...
        if (curPage === 1 && numPages > 1) return generateForwardButton(curPage);
        // Last page
        if (curPage === numPages && numPages > 1) return generateBackButton(curPage);
        // Other page
        if (curPage < numPages) return generateBackButton(curPage) + generateForwardButton(curPage);
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"3umpu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7YaI3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire0e3d")
